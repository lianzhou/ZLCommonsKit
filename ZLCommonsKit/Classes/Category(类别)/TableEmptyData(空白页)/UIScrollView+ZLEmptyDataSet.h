...
@protocol ZLScrollViewEmptyDelegate <UIScrollViewDelegate>

@optional
- (int)scrollViewEmptyCount:(UIScrollView *)scrollView;
- (UIColor *)zl_backgroundColorForEmptyDataSet:(UIScrollView *)scrollView;

@end


@interface UIScrollView (ZLEmptyDataSet)<DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>

@property (weak, nonatomic) id<ZLScrollViewEmptyDelegate> delegate;
