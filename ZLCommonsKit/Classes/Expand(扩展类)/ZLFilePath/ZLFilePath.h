 ...
 *  沙盒路径类型
 */
typedef NS_ENUM(NSUInteger, ZLLocalFilePathType) {
    ZLLocalFilePathTypeDocument,
    ZLLocalFilePathTypeLibrary,
    ZLLocalFilePathTypeTemporary,
    ZLLocalFilePathTypePreference,
    ZLLocalFilePathTypeCaches,
};

@interface ZLFilePath : NSObject
