//
//  JZDataAnalysisModuleAttributesModel.h
//  eStudy(comprehensive)
//
//  Created by Allen_Xu on 2017/12/26.
...
@class
    ...
    JZDataAnalysisEventAppStart,
    JZDataAnalysisEventAppQuit,
    JZDataAnalysisEventAppInstall,
    JZDataAnalysisEventAppViewScreen,
    JZDataAnalysisEventButtonClick,
    JZDataAnalysisEventAdClick,
    JZDataAnalysisEventSearch,
    JZDataAnalysisEventViewCourseDetail,
    JZDataAnalysisEventAccountRechargeClick,
    JZDataAnalysisEventGetAccountRecharge,
    JZDataAnalysisEventPointRechargeClick,
    JZDataAnalysisEventGetPointRecharge,
    JZDataAnalysisEventEliveOpenClick,
    JZDataAnalysisEventAirCourseOpenClick,
    JZDataAnalysisEventShare,
    JZDataAnalysisEventStartWatchCourseVideo,
    JZDataAnalysisEventFinishWatchCourseVideo,
    JZDataAnalysisEventAnnouncementRelease,
    JZDataAnalysisEventNewsRelease,
    JZDataAnalysisEventAssignWork,
    JZDataAnalysisEventSubmitWork,
    JZDataAnalysisEventImproveStart,
    JZDataAnalysisEventImproveFinish,
    JZDataAnalysisEventCourseFinish
;

//仅供引用子类名,实际埋点不使用该model,而是使用特定event对应的model
@interface JZDataAnalysisModuleAttributesModel : JZDataAnalysisBaseModel

@end

# pragma mark -01- App 启动
@interface JZDataAnalysisEventAppStart : JZDataAnalysisBaseModel

@end
# pragma mark -02- App 退出
@interface JZDataAnalysisEventAppQuit : JZDataAnalysisBaseModel

@end

# pragma mark -03- App 激活
@interface JZDataAnalysisEventAppInstall : JZDataAnalysisBaseModel

@end

# pragma mark -04- App浏览页面
@interface JZDataAnalysisEventAppViewScreen : JZDataAnalysisBaseModel
...
# pragma mark -05- 按钮点击
@interface JZDataAnalysisEventButtonClick : JZDataAnalysisBaseModel
...
# pragma mark -06- 广告点击
@interface JZDataAnalysisEventAdClick : JZDataAnalysisBaseModel
...
# pragma mark -07- 搜索
@interface JZDataAnalysisEventSearch : JZDataAnalysisBaseModel
...
@interface JZDataAnalysisEventViewCourseDetail : JZDataAnalysisBaseModel
...
@interface JZDataAnalysisEventAccountRechargeClick : JZDataAnalysisBaseModel


@end

# pragma mark -10- 发起账户充值
@interface JZDataAnalysisEventGetAccountRecharge : JZDataAnalysisBaseModel
...
@interface JZDataAnalysisEventPointRechargeClick : JZDataAnalysisBaseModel

@end

# pragma mark -12- 发起积分充值
@interface JZDataAnalysisEventGetPointRecharge : JZDataAnalysisBaseModel
...
@interface JZDataAnalysisEventEliveOpenClick : JZDataAnalysisBaseModel
...
@interface JZDataAnalysisEventAirCourseOpenClick : JZDataAnalysisBaseModel

@end

# pragma mark -15- 分享
@interface JZDataAnalysisEventShare : JZDataAnalysisBaseModel
...
@interface JZDataAnalysisEventStartWatchCourseVideo : JZDataAnalysisBaseModel

@end


# pragma mark -17- 结束观看视频
@interface JZDataAnalysisEventFinishWatchCourseVideo : JZDataAnalysisBaseModel
...
# pragma mark -18- 发布通知
@interface JZDataAnalysisEventAnnouncementRelease : JZDataAnalysisBaseModel

@end

# pragma mark -19- 发布动态
@interface JZDataAnalysisEventNewsRelease : JZDataAnalysisBaseModel

@end

# pragma mark -20- 布置作业
@interface JZDataAnalysisEventAssignWork : JZDataAnalysisBaseModel
...
# pragma mark -21- 提交作业
@interface JZDataAnalysisEventSubmitWork : JZDataAnalysisBaseModel
@property (nonatomic, copy) NSString * workID;//作业ID
@property (nonatomic, copy) NSString * workType;//作业类型  题库作业，课外作业
@property (nonatomic, strong) NSArray * workPattern;//作业形式  语音，文字，图片，单选题，多选题
@property (nonatomic, copy) NSString * bookEdition;//教材版本
...
# pragma mark -22- 开始提分
@interface JZDataAnalysisEventImproveStart : JZDataAnalysisBaseModel
...
# pragma mark -23- 完成提分
@interface JZDataAnalysisEventImproveFinish : JZDataAnalysisBaseModel
...
# pragma mark -24- 完成课程
@interface JZDataAnalysisEventCourseFinish : JZDataAnalysisBaseModel
