...
#import "ZLSearchPushTransition.h"
#import "ZLSystemMacrocDefine.h"

@interface ZLSearchPushTransition ()<CAAnimationDelegate>
{
    
    UIViewController<ZLSearchPushTransitionDelegate> * _fromVC;
    UIViewController<ZLSearchPushTransitionDelegate> *_toVC;
    ...
    ZLSearchPushAnimationTransitionType         _transitionType;
...
@implementation ZLSearchPushTransition
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext{
    ...
    if (_transitionType == ZLSearchPushAnimationTransitionTypeLeft || _transitionType == ZLSearchPushAnimationTransitionTypeRight) {
