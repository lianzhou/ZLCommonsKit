...
@interface ZLUtilsTools ()

@end

@implementation ZLUtilsTools

+ (ZLUtilsTools *) sharedInstance{
    static ZLUtilsTools *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[ZLUtilsTools alloc] init];
    });
    return instance;
}
// 更改上拉加载
...
{
    [ZLUtilsTools postNoti:notiName withObject:nil];
}

+ (void)postNoti:(NSString *)notiName withObject:(id)obj
{
    [ZLUtilsTools postNoti:notiName withObject:obj withUserInfo:nil];
}

+ (void)postNoti:(NSString *)notiName withObject:(id)obj withUserInfo:(NSDictionary *)infoDict
{
    if (ZLStringIsNull(notiName)) {
        return;
    }
    [[ZLUtilsTools defaultCenter] postNotificationName:notiName object:obj userInfo:infoDict];
}
...
{
    UIImage *img = nil;
    if (!ZLCheckObjectNull(titleHtml)) {
