...
@interface JZSearchBarTransition() {
...
@end
@implementation JZSearchBarTransition
...
- (void)creatDimissAnimation {
    ...
    JZCustomSearchBar *searchBar = (JZCustomSearchBar *)[_fromView viewWithTag:1111];
    
    [searchBar resignFirstResponder];
    [searchBar setShowsCancelButton:NO animated:YES];
    [UIView animateWithDuration:_duration delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
        _fromView.backgroundColor  = [JZ_KMainColor colorWithAlphaComponent:0];
        backView.frame = _endRect;
