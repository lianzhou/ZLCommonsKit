...
@implementation JZCoretextObject

@end

@interface JZCoretextManager ()<
DTAttributedTextContentViewDelegate,
DTLazyImageViewDelegate
>

@property(nonatomic, strong) JZCoretextObject *coretextObject;

@end

static DTAttributedLabel *_tlbAttributedLabel;

static JZCoretextManager *__manager;

@implementation JZCoretextManager
...
+ (instancetype)shareManager {
    ...
    dispatch_once(&onceToken, ^{
        ...
        __manager = [[JZCoretextManager alloc] init];
    });
