...
#define kDefaultJZFont(A) [UIFont systemFontOfSize:(A)]   //默认字体
#define KpicViewHeight KimageWidth + 20

@interface JZShowContentView ()
...
@implementation JZShowContentView
...
- (HPGrowingTextView *)contentTextView
{
    if (!_contentTextView) {
        ...
        _contentTextView.font = kDefaultJZFont(14.0);
...
- (UIView *)picView
{
    if (!_picView) {
        ...
        _picView.backgroundColor = JZ_KMainColor;
...
- (UILabel *)desLabel
{
    if (!_desLabel) {
        ...
        _desLabel.font = kDefaultJZFont(13.0);
