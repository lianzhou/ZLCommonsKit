...
typedef enum : NSUInteger {
    ZLLabelLongPressUrl,
    ZLLabelLongPressAt,
    ZLLabelLongPressPhone,
} ZLLabelHeightLongPressType;

@protocol ZLLabelDelegate <NSObject>

@optional

//文本轻点
- (void)zlLabel:(ZLLabel *)zlLabel didtapSelectStr:(NSString *)selectStr;
//文本长按
- (void)zlLabel:(ZLLabel *)zlLabel didLongPressSelectStr:(NSString *)selectStr;
//高亮轻点
- (void)zlLabel:(ZLLabel *)zlLabel didHeightTextTapSelectStr:(NSString *)selectStr withTapType:(ZLLabelHeightLongPressType)hieghtType;
//高亮长按
- (void)zlLabel:(ZLLabel *)zlLabel didHeightTextLongPressSelectStr:(NSString *)selectStr withLongPressType:(ZLLabelHeightLongPressType)hieghtType;

//特殊字符高亮点击
- (void)zlLabel:(ZLLabel *)zlLabel didSpecialTextHeightTapSelectStr:(NSString *)selectStr;


- (void)zlLabel:(ZLLabel *)zlLabel didSelectStrIndex:(NSInteger)selectIndex;
@end
@interface ZLLabel : YYLabel
...
@property(nonatomic,assign)id<ZLLabelDelegate>delegate;
