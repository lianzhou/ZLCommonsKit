...
#import "ZLAnimationTextField.h"
#import <Masonry/Masonry.h>
@interface ZLAnimationTextFieldConfig ()

@end

@implementation ZLAnimationTextFieldConfig
...
@interface ZLAnimationTextField ()<UITextFieldDelegate>

@property (nonatomic, strong) UIImageView *sperLine;
@property (nonatomic, strong) UIButton    *clearButton;
@property (nonatomic, strong) UIButton    *rightButton;
@property (nonatomic, strong) ZLAnimationTextFieldConfig * textFieldConfig;
@end

@implementation ZLAnimationTextField
