...
#define ZL_IOS9  ([[[UIDevice currentDevice] systemVersion] floatValue] >= 9.0)

@interface ZLCustomSearchBar ()
{
    CGRect _searchBarFrame;
}
@end

@implementation ZLCustomSearchBar
    ...
    if (view) {
        ...
        if ([view isKindOfClass:[UIButton class]]) {
            ...
            for (UIView *subView in view.subviews) {
                [ZLCustomSearchBar changeSearchBarCancelView:subView title:title color:color font:font];
            }
        }
