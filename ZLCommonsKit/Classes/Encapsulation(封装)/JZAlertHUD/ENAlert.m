                ...
                block:(nullable UIAlertViewCallBackBlock)alertBlock
{
    if (JZ_IOS8) {
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:title
                                                                       message:JZIFISNULL(message)
                                                                preferredStyle:UIAlertControllerStyleAlert];
        if (!JZStringIsNull(cancelButtonTitle)) {
        ...
        [[JZContext shareInstance].currentViewController presentViewController:alert animated:YES completion:nil];
    }else{
