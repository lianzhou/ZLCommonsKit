...
@implementation JZBarButtonItem
...
- (void)makeConstraints{
    ...
    self.badgeStyle = JZTabItemBadgeStyleHidden;
}
...
- (void)setBadgeStyle:(JZTabItemBadgeStyle)badgeStyle{
...
- (void)updateBadge {
    if (self.badgeStyle == JZTabItemBadgeStyleNumber) {
        if (self.badge == 0) {
    ...
    } else if (self.badgeStyle == JZTabItemBadgeStyleDot) {
        ...
        self.badgeLabel.hidden = NO;
    }else if(self.badgeStyle == JZTabItemBadgeStyleHidden) {
        self.badgeLabel.hidden = YES;
    }
}
