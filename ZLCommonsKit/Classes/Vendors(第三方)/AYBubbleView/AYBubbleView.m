...
- (void)addBubbleAnimation {
    ...
    //    scaleXAnimation.values = @[@1.0,@1.0,@0.9];
    ...
    //    scaleYAnimation.values = @[@1.0,@1.0,@0.9];
...
// 隐藏角标
- (void)hidenBubbleView:(BOOL)hiden {
    
    self.frontView.hidden = hiden;
    self.hidden = hiden;
}
// 移除角标
